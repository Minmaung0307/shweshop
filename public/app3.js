...
function onNavClick(item, btn) {
  ...
  if(item.type==='view'){
  if(item.value==='orders'){ switchView('orders'); loadOrders(); return; }
  if(item.value==='member'){ document.getElementById('memberModal')?.showModal(); return; }
  if(item.value==='analytics'){ switchView('analytics'); renderAnalytics(); return; }
}
}
...
function renderHomeSections(){
  ...
  catsAll.forEach((cat, idx)=>{
    // audience filter: 'all' => အကုန်ပြ, 'men' => aud==='men' သာ
    const list = (DEMO_PRODUCTS||[]).filter(p=>{
      const okAud = currentAudience==='all' ? true : (p.aud||'all')===currentAudience;
      return okAud && p.cat===cat;
    });

    if(!list.length) return; // ဒီ category ကို audience filter ဖြတ်ပြီး အရာမရှိရင် မပြ
...
const DEMO_PRODUCTS = [
  ...
  { id:'n1', title:'Men Running Shorts',  price:18, cat:'Fashion', aud:'men',
  img:'images/products/men/n1/thumb.jpg', images:['images/products/men/n1/main.jpg'], desc:'Lightweight', specs:['Quick-dry','Elastic waist'] },
{ id:'n2', title:'Women Yoga Mat',      price:22, cat:'Beauty',  aud:'women',
  img:'images/products/women/n2/thumb.jpg', images:['images/products/women/n2/main.jpg'], desc:'Non-slip', specs:['183×61cm','6mm'] },
{ id:'n3', title:'Kids Story Book',     price:6,  cat:'Baby',    aud:'kids',
  img:'images/products/kids/n3/thumb.jpg', images:['images/products/kids/n3/main.jpg'], desc:'Colorful tales' },
{ id:'n4', title:'Pet Chew Toy',        price:7,  cat:'Pets',    aud:'pets',
  img:'images/products/pets/n4/thumb.jpg', images:['images/products/pets/n4/main.jpg'], desc:'Durable rubber' },
{ id:'n5', title:'Car Phone Mount',     price:9,  cat:'Auto',    aud:'all',
  img:'images/products/all/n5/thumb.jpg', images:['images/products/all/n5/main.jpg'], desc:'360° rotation' },
{ id:'n6', title:'Home LED Strip',      price:12, cat:'Home',    aud:'all',
  img:'images/products/all/n6/thumb.jpg', images:['images/products/all/n6/main.jpg'], desc:'5m RGB' }
];
